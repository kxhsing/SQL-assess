...
SELECT models.name AS model_name, brands.name AS brand_name, brands.headquarters FROM models JOIN brands ON (models.brand_id = brands.brand_id) WHERE brands.name='Ford' AND models.name='Mustang';
...
SELECT * FROM brands WHERE founded IN (1852, 1901, 1902) ORDER by founded;
...
SELECT models.year, models.name, models.model_id, awards.name FROM models LEFT JOIN awards ON (awards.winner_id = models.model_id) WHERE models.year >= 1964;
...
SELECT brands.name, brands.founded FROM brands LEFT JOIN models ON (models.brand_id = brands.brand_id) WHERE brands.brand_id NOT IN (SELECT models.brand_id FROM models); 
...
SELECT models.brand_id FROM models GROUP BY models.brand_id HAVING COUNT(*) > 5;
...
SELECT models.name, models.year FROM models JOIN brands ON (brands.brand_id = models.brand_id) WHERE models.year IN (SELECT brands.founded FROM brands);